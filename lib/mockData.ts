...
import type { Order, WorkflowStage, OrderStatus, KpiData, Doctor, Vendor, WorkflowHistoryEntry, Profile, MarketingLead, MarketingTouchpoint, MarketingInService } from './types';
...
const orderStatuses: OrderStatus[] = ["Pending Intake", "In Progress", "Missing Info", "Verified", "Pending", "Denied"];
